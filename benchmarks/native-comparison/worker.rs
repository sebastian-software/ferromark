...
// Use the same adapter for the original OX APIs and the unchanged v2 public APIs.
mod ox {
        ...
        mod $module {
            ...
            impl Renderer {
                pub fn new(gfm: bool, mode: Mode, max_source: usize) -> Self {
                    let options = api::ParserOptions {
                        tables: gfm,
                        strikethrough: gfm,
                        task_lists: gfm,
                        ..api::ParserOptions::default()
                    };
                    let html_options = api::HtmlRendererOptions {
                        autolink_urls: false,
                        autolink_target_blank: false,
                        link_target_blank: false,
                        ..api::HtmlRendererOptions::new()
                    };
                    Self {
...
arena_engine!(ox_engine, ox);
arena_engine!(v2_engine, v2);
