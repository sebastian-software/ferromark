...
`fixtures.py` emits thirteen authored inputs covering nested source spans, indented
...
link rendering, image alternatives, balanced brackets, and unclosed delimiters.
