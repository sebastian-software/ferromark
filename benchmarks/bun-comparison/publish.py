...
reference-resolution limit. Ordinary HTML flow whitespace is accepted. {data['verification']['eligible']} of
{data['verification']['total']} input/configuration pairs passed the revised shared output gate;
