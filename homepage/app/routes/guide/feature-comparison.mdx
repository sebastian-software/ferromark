...
V2 preserves authored punctuation by default. An optional, locale-aware
typography pass is available after parsing in Rust and through the Node.js
`typography` option. It never guesses a language. See the [typography guide](/guide/typography)
for configuration and protected syntax; the former English-oriented parser
option remains removed.
