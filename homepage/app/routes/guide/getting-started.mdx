...
import { headlineThroughput } from "../../components/benchmarks"
...
- Throughput reaches {headlineThroughput} on the CommonMark 50 KB fixture of the published [benchmark run](/guide/benchmarks).
