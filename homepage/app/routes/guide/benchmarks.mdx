...
[Full results and per-document timings](https://github.com/sebastian-software/ferromark/blob/main/docs/reports/2026-09-21-native-release-fixed/README.md),
[exact flags](https://github.com/sebastian-software/ferromark/blob/main/docs/reports/2026-09-21-native-release-fixed/FLAGS.md), and
[HTML differences](https://github.com/sebastian-software/ferromark/blob/main/docs/reports/2026-09-21-native-release-fixed/OUTPUT-REVIEW.md)
include raw measurements, source hashes, and reproducible configuration.
The [held-out PGO comparison](https://github.com/sebastian-software/ferromark/blob/main/docs/reports/2026-09-21-native-release-fixed/README.md#profile-guided-optimization-measured-on-the-held-out-half)
