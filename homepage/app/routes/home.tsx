  ...
  return (
    <main className="landing">
        ...
        <div className="landing-principle-list">
          ...
          <article>
            ...
            <div>
              ...
              <p>
                Front matter, headings for navigation, footnotes, callouts, table classes, and
                merged cells. Enable the syntax your authors need and get the output your
                application can use.
              </p>
      ...
      <section className="landing-reference" aria-labelledby="reference-title">
        ...
        <p>
          Rust and Node.js have their own guides and APIs. Markdown syntax, trust policies, and
          output semantics live in one shared reference.
        </p>
