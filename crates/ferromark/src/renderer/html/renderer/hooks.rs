...
impl HtmlRenderer {
    ...
    pub(in crate::renderer::html::renderer) fn render_document_with_hooks<H: HtmlRenderHooks>(
        &mut self,
        document: &Document<'_>,
        hooks: &mut H,
    ) {
    ...
    pub(in crate::renderer::html::renderer) fn render_node_with_hooks<H: HtmlRenderHooks>(
        &mut self,
        node: &Node<'_>,
        hooks: &mut H,
    ) {
    ...
    pub(in crate::renderer::html::renderer) fn render_inline_node_with_hooks<H: HtmlRenderHooks>(
        &mut self,
        node: &Node<'_>,
        hooks: &mut H,
    ) {
