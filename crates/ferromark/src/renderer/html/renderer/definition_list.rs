...
use crate::ast::{DefinitionList, DefinitionListDefinition, DefinitionListTerm, Node};

use super::HtmlRenderer;

impl HtmlRenderer {
    pub(in crate::renderer::html::renderer) fn render_definition_list(
        &mut self,
    ...
    pub(in crate::renderer::html::renderer) fn render_definition_list_term(
        &mut self,
    ...
    pub(in crate::renderer::html::renderer) fn render_definition_list_definition(
        &mut self,
