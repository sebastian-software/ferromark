...
//! pipeline terminates without panicking. This stable Rust guard runs in
//! the ordinary test suite, catching regressions such as the historical
//! whitespace-only-input hang without a separate fuzzing toolchain.
//!
