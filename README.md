...
[Rust API](https://docs.rs/ferromark/2.1.2/ferromark/) ·
...
completes Markdown to HTML 2.1× faster than Ferromark v1, 2.6× faster than
pulldown-cmark, 3.5× faster than md4c, and 6.0× faster than Bun's native engine
on Apple Silicon (Apple M1 Pro, fresh parser state, 2026-09-21). On Linux x86-64
(GitHub-hosted runner, AMD EPYC 9V74, 2026-09-24) the four ratios are 2.0×,
2.4×, 3.2×, and 4.5×; that runner is shared, so
