...
Ferromark revision: `8a9ad15c1a899f4e7c125a9b74f209863ffb5356`. Ox Content source: `5c97078779cf099245a78aacca8fa7cc5e993316` (release `3.2.0`).
...
| --- | ---: | ---: | ---: | ---: | --- |
| `commonmark/short` | 18 | 0.49 | 0.29 | 0.59× | 0.49–0.50 / 0.29–0.29 |
| `tables/tables-commonmark-inline` | 4,800 | 32.57 | 37.14 | 1.14× | 32.38–32.65 / 36.74–37.16 |
| `gfm_overlap/features` | 5,050 | 36.79 | 35.08 | 0.95× | 36.45–36.82 / 34.72–35.11 |
...
```sh
python3 benchmarks/native-pipeline-comparison/report.py docs/reports/2026-09-12-ox-corpus-optimizations/ox-content --check
```
