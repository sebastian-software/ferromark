...
Ferromark v2 is pinned to `7c887a2b` and v1 to `4e15141`; the other engines retain
...
The segmented definition pass measured here changes no option. Definition
lists and footnotes are off in both lanes; link reference definitions are
core CommonMark syntax and are unaffected by any switch in this table. The
pass is an internal discovery strategy, not a syntax mode.
