...
production_hash = hashlib.sha256((args.work / "production-parser.rs").read_bytes()).hexdigest()
if production_hash != metadata["production_source_hashes"]["src/block/parser.rs"]:
