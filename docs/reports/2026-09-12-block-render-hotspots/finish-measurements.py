...
for script in ['verify-fences.py','verify-timing.py','verify-blocks.py','verify-extra.py','verify-extended.py']:
 subprocess.run([sys.executable,str(W/script),'production'],check=True)
for record in ['fence-verification.json','timing-verification.json','block-verification.json','extra-verification.json','extended-verification.json']:
