...
impl HtmlRenderer {
    pub(in crate::renderer::html::renderer) fn render_table_with_hooks<H: HtmlRenderHooks>(
        &mut self,
        table: &Table<'_>,
        hooks: &mut H,
    ) {
    ...
    pub(in crate::renderer::html::renderer) fn render_definition_list_with_hooks<
        H: HtmlRenderHooks,
    >(
        &mut self,
    ...
    pub(in crate::renderer::html::renderer) fn render_definition_list_term_with_hooks<
        H: HtmlRenderHooks,
    >(
        &mut self,
    ...
    pub(in crate::renderer::html::renderer) fn render_definition_list_definition_with_hooks<
        H: HtmlRenderHooks,
    >(
        &mut self,
    ...
    fn render_table_row_with_hooks<H: HtmlRenderHooks>(
        ...
        row: &TableRow<'_>,
        is_header: bool,
        align: &crate::allocator::Vec<'_, AlignKind>,
        hooks: &mut H,
    ) {
        self.write("<tr");
