...
impl HtmlRenderer {
    ...
    pub(in crate::renderer::html::renderer) fn render_heading_with_hooks<H: HtmlRenderHooks>(
        &mut self,
        heading: &Heading<'_>,
        hooks: &mut H,
    ) {
    ...
    pub(in crate::renderer::html::renderer) fn render_block_quote_with_hooks<H: HtmlRenderHooks>(
        &mut self,
    ...
    pub(in crate::renderer::html::renderer) fn render_list_with_hooks<H: HtmlRenderHooks>(
        &mut self,
        list: &List<'_>,
        hooks: &mut H,
    ) {
    ...
    pub(in crate::renderer::html::renderer) fn render_list_item_with_hooks<H: HtmlRenderHooks>(
        &mut self,
